...
class MeiyanForm extends Model
{
	public $username;
	public $phone;
	public $email;
	...
	{
		return [
			[['username', 'phone', 'email', 'currentSchool', 'grade', 'toefl', 'gre', 'gpa_u', 'gpa_major'], 'required', 'message' => '{attribute}不能为空'],
			...
			['applicationProject', 'default', 'value' => 3],
